...
h1 = figure(1); hold on;
title('Standard Error - Phantom - Pointer');
%h2 = figure(2); hold on;
...
legend({'Plane','Third Section','Fourth Section','Mean','Standard Deviation'},'Location','northwest')
